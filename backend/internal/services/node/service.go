...
// ============================================================================
// State Reconciliation Operations (Requires Proto Regeneration)
// ============================================================================
// NOTE: The following handlers are commented out until proto types are regenerated:
// - SyncFullState
// - NotifyVMChange
// - NotifyStorageChange
// - handleVMDeleted
// - mapPowerStateFromProto
//
// To enable state reconciliation:
// 1. Run: cd proto && buf generate
// 2. Uncomment the handlers in this file
// 3. Rebuild: cd backend && go build ./...
