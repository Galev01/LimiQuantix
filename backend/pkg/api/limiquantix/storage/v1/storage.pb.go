...
type CephConfig struct {
	...
	SecretUuid    string `protobuf:"bytes,7,opt,name=secret_uuid,json=secretUuid,proto3" json:"secret_uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CephConfig) GetSecretUuid() string {
	if x != nil {
		return x.SecretUuid
	}
	return ""
...
type IscsiConfig struct {
	...
	// This is auto-generated by the Node Daemon if not specified
	VolumeGroup   string `protobuf:"bytes,7,opt,name=volume_group,json=volumeGroup,proto3" json:"volume_group,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IscsiConfig) GetChapEnabled() bool {
	if x != nil {
...
func (x *IscsiConfig) GetLun() uint32 {
	if x != nil {
		return x.Lun
	}
	return 0
...
func (x *IscsiConfig) GetVolumeGroup() string {
	if x != nil {
		return x.VolumeGroup
	}
	return ""
...
const file_limiquantix_storage_v1_storage_proto_rawDesc = "" +
	...
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\"\x99\x01\n" +
	"\tNfsConfig\x12\x16\n" +
	...
	"\fvolume_group\x18\a \x01(\tR\vvolumeGroup\"\xd5\x01\n" +
