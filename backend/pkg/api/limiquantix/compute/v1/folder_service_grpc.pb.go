...
const (
	FolderService_CreateFolder_FullMethodName  = "/limiquantix.compute.v1.FolderService/CreateFolder"
	FolderService_GetFolder_FullMethodName     = "/limiquantix.compute.v1.FolderService/GetFolder"
	FolderService_ListFolders_FullMethodName   = "/limiquantix.compute.v1.FolderService/ListFolders"
	FolderService_UpdateFolder_FullMethodName  = "/limiquantix.compute.v1.FolderService/UpdateFolder"
	FolderService_DeleteFolder_FullMethodName  = "/limiquantix.compute.v1.FolderService/DeleteFolder"
	FolderService_GetFolderTree_FullMethodName = "/limiquantix.compute.v1.FolderService/GetFolderTree"
)
...
type FolderServiceClient interface {
	...
	GetFolderTree(ctx context.Context, in *GetFolderTreeRequest, opts ...grpc.CallOption) (*FolderTree, error)
}
...
func (c *folderServiceClient) GetFolderTree(ctx context.Context, in *GetFolderTreeRequest, opts ...grpc.CallOption) (*FolderTree, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FolderTree)
	err := c.cc.Invoke(ctx, FolderService_GetFolderTree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FolderServiceServer interface {
	...
	// GetFolderTree returns the folder tree starting from a root.
	GetFolderTree(context.Context, *GetFolderTreeRequest) (*FolderTree, error)
}
...
func (UnimplementedFolderServiceServer) GetFolderTree(context.Context, *GetFolderTreeRequest) (*FolderTree, error) {
...
func _FolderService_GetFolderTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFolderTreeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FolderServiceServer).GetFolderTree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FolderService_GetFolderTree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FolderServiceServer).GetFolderTree(ctx, req.(*GetFolderTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FolderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "limiquantix.compute.v1.FolderService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FolderService_GetFolderTree_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "limiquantix/compute/v1/folder_service.proto",
}
