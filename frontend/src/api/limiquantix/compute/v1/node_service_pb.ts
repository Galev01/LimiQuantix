 ...
 *
 * @generated from message limiquantix.compute.v1.StoragePoolStatusReport
 */
export type StoragePoolStatusReport = Message<"limiquantix.compute.v1.StoragePoolStatusReport"> & {
  /**
  ...
  /**
   * @generated from field: limiquantix.compute.v1.StoragePoolStatusReport.HealthStatus health = 2;
   */
  health: StoragePoolStatusReport_HealthStatus;
   ...
   *
   * @generated from field: uint32 volume_count = 7;
   */
  volumeCount: number;
   ...
   *
   * @generated from field: int64 last_mount_unix = 9;
   */
  lastMountUnix: bigint;
};

/**
 * Describes the message limiquantix.compute.v1.StoragePoolStatusReport.
 * Use `create(StoragePoolStatusReportSchema)` to create a new message.
 */
export const StoragePoolStatusReportSchema: GenMessage<StoragePoolStatusReport> = /*@__PURE__*/
  messageDesc(file_limiquantix_compute_v1_node_service, 15);

/**
 * Health status
 *
 * @generated from enum limiquantix.compute.v1.StoragePoolStatusReport.HealthStatus
 */
export enum StoragePoolStatusReport_HealthStatus {
  /**
  ...
  /**
   * @generated from enum value: HEALTH_UNMOUNTED = 4;
   */
  HEALTH_UNMOUNTED = 4,
}

/**
 * Describes the enum limiquantix.compute.v1.StoragePoolStatusReport.HealthStatus.
 */
export const StoragePoolStatusReport_HealthStatusSchema: GenEnum<StoragePoolStatusReport_HealthStatus> = /*@__PURE__*/
  enumDesc(file_limiquantix_compute_v1_node_service, 15, 0);
...
export const NodeUpdate_UpdateTypeSchema: GenEnum<NodeUpdate_UpdateType> = /*@__PURE__*/
  enumDesc(file_limiquantix_compute_v1_node_service, 23, 0);
