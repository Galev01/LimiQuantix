...
const COMPONENT_STYLES: Record<string, ComponentStyle> = {
  // Backend services
  'controlplane': { icon: Server, color: 'text-blue-400', bgColor: 'bg-blue-400/10', label: 'Control Plane' },
  'vm-service': { icon: Monitor, color: 'text-emerald-400', bgColor: 'bg-emerald-400/10', label: 'VM Service' },
  'storage-service': { icon: HardDrive, color: 'text-amber-400', bgColor: 'bg-amber-400/10', label: 'Storage' },
  'network-service': { icon: Network, color: 'text-purple-400', bgColor: 'bg-purple-400/10', label: 'Network' },
  'node-service': { icon: Server, color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', label: 'Node Service' },
  'scheduler': { icon: Clock, color: 'text-sky-400', bgColor: 'bg-sky-400/10', label: 'Scheduler' },
  'api': { icon: Activity, color: 'text-indigo-400', bgColor: 'bg-indigo-400/10', label: 'API' },
  'grpc': { icon: Activity, color: 'text-violet-400', bgColor: 'bg-violet-400/10', label: 'gRPC' },
  ...
  'ui-cluster': { icon: Server, color: 'text-blue-400', bgColor: 'bg-blue-400/10', label: 'UI: Cluster' },
  'ui-admin': { icon: Settings, color: 'text-gray-400', bgColor: 'bg-gray-400/10', label: 'UI: Admin' },
  ...
  'ui-alerts': { icon: Bell, color: 'text-orange-400', bgColor: 'bg-orange-400/10', label: 'UI: Alerts' },
  'ui-monitoring': { icon: Activity, color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', label: 'UI: Monitoring' },
  ...
  'ui-folders': { icon: Folder, color: 'text-yellow-400', bgColor: 'bg-yellow-400/10', label: 'UI: Folders' },
  'ui-images': { icon: Disc, color: 'text-pink-400', bgColor: 'bg-pink-400/10', label: 'UI: Images' },
